...
export async function sendOrderConfirmations(prevState, formData, { selectedQuantities }) {
  ...
  const order = {
    ...
    sliceToggle: formData.get('sliceToggle'),
  ...
  try {
    ...
    const response = await fetch(
      "https://script.google.com/macros/s/AKfycbyJkx_BuySjWbkeFHNy-0yRgA3PcLfiKvTdWYDGPC49hlgL5k6LnH_Dig4Dei8RdCst/exec",
      {
        method: "POST",
